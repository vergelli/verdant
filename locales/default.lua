...
ZO_CreateStringId("VERDANT_TRI_TIP_DIED",         "You fought for them - the damage won.")
...
ZO_CreateStringId("VERDANT_TRI_TIP_ONESHOT",      "Instant kill - not counted against you.")
