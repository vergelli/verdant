...
ZO_CreateStringId("VERDANT_TRI_TIP_SAVE",         "dropped this low - your healing brought them back")
ZO_CreateStringId("VERDANT_TRI_TIP_RECOVERED",    "recovered without your healing (potion, another healer or their own skills)")
ZO_CreateStringId("VERDANT_TRI_TIP_DIED",         "you fought for them, but the damage won")
ZO_CreateStringId("VERDANT_TRI_TIP_MISSED",       "died without a single heal from you")
ZO_CreateStringId("VERDANT_TRI_TIP_CUT",          "the data cut off (out of range or the fight ended)")
ZO_CreateStringId("VERDANT_TRI_TIP_ONESHOT",      "instant kill - nobody could have reacted; not counted against you")
ZO_CreateStringId("VERDANT_TRI_TIP_RT",           " - you reacted in %.1fs")
ZO_CreateStringId("VERDANT_TRI_TIP_VIA_HOTS",     " - saved by your running hots")
...
ZO_CreateStringId("VERDANT_GRAPH_LIB",   "Lib")
