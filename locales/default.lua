...
ZO_CreateStringId("VERDANT_TRI_LEG_SAVE",         "your save")
ZO_CreateStringId("VERDANT_TRI_LEG_OTHER",        "recovered w/o you")
ZO_CreateStringId("VERDANT_TRI_LEG_LOST",         "died")
ZO_CreateStringId("VERDANT_TRI_LEG_MISSED",       "missed")
ZO_CreateStringId("VERDANT_TRI_LEG_SCORE",        "n/m = your saves")
