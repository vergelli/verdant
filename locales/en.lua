...
Verdant.L = {
  ...
  HELP_LINES     = {
    "  /verdant show          - show the bar",
    "  /verdant hide          - hide the bar",
    "  /verdant toggle        - toggle the bar",
    "  /verdant tribar        - toggle the triple-metric window",
    "  /verdant clear         - clear buffers, counters and peak marks",
    "  /verdant readout       - print current metrics to chat",
    "  /verdant skills        - list ability IDs not yet colour-classified",
    "  /verdant diag          - print engine event counters",
