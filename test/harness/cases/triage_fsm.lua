return function(H)
  ...
  H.power("group4", 15000, 40000)
  H.power("group4", 23000, 40000)
  H.advance(200)
  H.heal({ hit = 1500, target_name = "Ally4", target_unit_id = 604 })
  H.advance(2500)
  local s5 = T.summary()
  ok(s5.counts.s == 3, "late heal within delta must upgrade O to S, S=" .. s5.counts.s)
  ok(s5.counts.s_star == 3, "late-attributed save must count as closed save")
  ok(s5.counts.o == 0, "no O expected after late attribution, O=" .. s5.counts.o)

  H.power("group2", 16000, 40000)
  H.power("group2", 39000, 40000)
  H.advance(2500)
  local s6 = T.summary()
  ok(s6.counts.o == 1, "unattended recovery must classify O after delta, O=" .. s6.counts.o)
  Verdant.Graph.on_stop_click()
