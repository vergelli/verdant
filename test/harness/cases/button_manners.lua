return function(H)
  ...
  ok(last_sound() == "sound:BOOK_OPEN", "opening the graph opens a book")
  clear()
  ...
  ok(last_sound() == "sound:BOOK_CLOSE", "closing the graph closes the book")

  clear()
  Verdant.Settings.toggle()
  ok(last_sound() == "sound:BOOK_OPEN", "settings opens like a book")
  clear()
  Verdant.Settings.toggle()
  ok(last_sound() == "sound:BOOK_CLOSE", "settings closes like a book")

  clear()
  Verdant.Library.toggle()
  ok(last_sound() == "sound:BOOK_OPEN", "the library opens like a book")
  clear()
  Verdant.Library.toggle()
  ok(last_sound() == "sound:BOOK_CLOSE", "the library closes like a book")
  clear()
