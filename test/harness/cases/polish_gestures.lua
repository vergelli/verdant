return function(H)
  ...
  ok(VerdantLibraryRow1Sel._hidden == false, "clicking selects the top row")
  Verdant.Library.on_row_click(2)
  ok(VerdantLibraryRow2Sel._hidden == false and VerdantLibraryRow1Sel._hidden == true, "clicking another row moves the selection")
  Verdant.Library.on_row_click(1)
  ok(VerdantLibraryRow1Sel._hidden == false, "and back")
  ...
  Verdant.Library.on_row_click(1)
  ok(VerdantLibrary._hidden == false, "the library is open")
  Verdant.Library.hide()
  ok(VerdantLibrary._hidden == true, "the library closes through its own hide, Escape is the game's business now")
