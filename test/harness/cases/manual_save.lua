return function(H)
  ...
  ok(H.update_registered("VerdantSavingSpin"), "a spinner ticks while saving")
  ok((btn._alpha or 1) < 1, "the save icon dims while saving")
  H.advance(400)
  ok(not H.update_registered("VerdantSavingSpin"), "the spinner stops when the save lands")
  ...
  ok(not H.update_registered("VerdantSavingSpin") and status._text:find("SAVED", 1, true) and not status._text:find("SAVING", 1, true),
